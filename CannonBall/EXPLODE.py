...
end_game = False
#
##scoreblit = pygame.Surface.blit(font.render(str(score),True,(0,0,0)))
##
##
...
class Scoring(object):
    ...
    def __init__(self, score, x, y):
        ...
        #self.points
        self.scoreFont = pygame.font.SysFont("arial", 25)
        self.font = pygame.font.SysFont("arial.ttf", 20)
        self.score = 0
        self.scoreDisplay = self.scoreFont.render(str(self.score), 1, (0, 0, 255))
        #self.image = self.scoreDisplay#black score

        
        #self.image = self.font.render(str(self.score),1,(0,0,0))#black score
        #self.rect = self.image.get_rect()

        #self.font = pygame.font.Font("data/fonts/ls.ttf", 20)
        #self.rect.x = 10
        #self.rect.y = 10
        self.x = x
        self.y = y
    def update(self):
        scoreDisplay = self.scoreFont.render(str(self.score), 1, (0, 0, 255))#Blue score 
        screen.blit(scoreDisplay,(10,10))
        self.score += 2
        #screen.blit(scoreBlit, (582, 7))
...
class Tank(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        #super(Tank, self).__init__(image = Tank.image, x = 1, y = 3)
...
##            self.kill()
    ...
    def die(self):
        ...
        new_explosion = Explosion(x = self.rect.x, y = self.rect.y)#instance of explosion#################################################################
...
class Church(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        #super(Church, self).__init__(image = Church.image, x = x, y = y, is_collideable = False)
