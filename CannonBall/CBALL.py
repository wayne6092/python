...
class Explosion(pygame.sprite.Sprite):
    ...
    #explosion.add("explosion1.bmp")
    def __init__(self, x, y):
        super().__init__()
        pygame.sprite.Sprite.__init__("explosion1.bmp")


        self.image = pygame.image.load(self)
        self.rect = self.image.get_rect()
...
##        self.image2 = pygame.image.load("explosion1.bmp")
##        self.rect = self.image2.get_rect()
##        self.image2.set_colorkey(self.image.get_at((0,0)))
##        self.repeat = 5
        # self.repeat_interval = 4
