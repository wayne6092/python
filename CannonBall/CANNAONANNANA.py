...
class Tank(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        #super(Tank, self).__init__(Tank.image, x = 1, y = 3)
...
class Missile(pygame.sprite.Sprite):
    ...
    def die(self):
        ...
        new_explosion = Explosion.__init__(images, x = self.rect.x, y = self.rect.y)#instance of explosion###########################################################
...
class Explosion(pygame.sprite.Sprite):
    ...
    pygame.image.load("explosion1.bmp")
    pygame.image.load("explosion2.bmp")
    pygame.image.load("explosion3.bmp")
    pygame.image.load("explosion4.bmp")
    pygame.image.load("explosion5.bmp")
    pygame.image.load("explosion6.bmp")
    pygame.image.load("explosion7.bmp")
    pygame.image.load("explosion8.bmp")
    pygame.image.load("explosion9.bmp")
    ...
    def __init__(self, x, y):
        ...
        super(Explosion, self).__init__(images = Explosion.images, x = x, y = y, repeat_interval = 4, is_collideable = False)
        self.image = images
        self.rect = self.image.get_rect()
        self.image.set_colorkey(self.image.get_at((0,0)))
        self.rect.x = x
